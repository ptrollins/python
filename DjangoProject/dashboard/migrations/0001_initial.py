    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_app', models.ForeignKey(to='dashboard.App')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_exercise', models.ForeignKey(to='dashboard.Exercise')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_class', models.ForeignKey(to='dashboard.Classroom')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AlterUniqueTogether(
            name='score',
            unique_together=set([('fk_student', 'date', 'fk_exercise')]),
        ),
        migrations.AlterUniqueTogether(
            name='exercise',
            unique_together=set([('fk_app', 'id_exercise')]),
        ),
        migrations.AddField(
            model_name='classroom',
            name='fk_school',
            field=models.ForeignKey(to='dashboard.School'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='classroom',
            unique_together=set([('id_class', 'fk_school')]),
        ),
    ]
